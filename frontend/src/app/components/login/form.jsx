    ...
    <div className="p-5 space-y-4">
      ...
      {sent ? (
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-sm text-green-800">
          ...
          <p className="mt-0.5">Vérifiez votre boîte mail et cliquez sur le lien pour vous connecter.</p>
        </div>
      ) : (
      ...
      <div className="pt-1 border-t border-gray-100">
        <button onClick={() => setOpen(false)} className="w-full text-sm text-gray-500 hover:text-gray-700 py-1">
          Fermer
        </button>
      </div>
    </div>
