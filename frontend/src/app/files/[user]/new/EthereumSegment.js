    ...
    <Segment disabled={!state}>
      ...
      <List divided relaxed>
        ...
        <List.Item>
          ...
          <List.Content>
            {isManager === null ? (
              <List.Description>Les droits d'accès sont en attente</List.Description>
            ) : isManager ? (
              <List.Description>Les droits d'accès ont été accordés</List.Description>
            ) : (
              <List.Description>Les droits d'accès ont été rejetés</List.Description>
            )}
          </List.Content>
        </List.Item>
